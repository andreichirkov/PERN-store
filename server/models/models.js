...
//Связь между Пользователем и Корзиной -> Один к Одному
User.hasOne(Basket)
...
//См. картинки в корне с нарисованными связями
//Пример: Одна запись Девайса в БД содержит много записай с Инфо (Характеристиками)
Device.hasMany(DeviceInfo, { as: 'info' })
DeviceInfo.belongsTo(Device)

//Для типа Многих ко Многих нужна связующая таблица, указывается через through
